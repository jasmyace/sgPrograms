runMF <- function(dat,progDir,BUGSDir,thisRun,z){
  ...
  freqs <- "Hello." #glmer(Peak_Males ~ 1 + CYear + (1 + CYear | Lek_ID),data=countDat[[i]],family="poisson")
