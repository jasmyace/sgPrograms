runMO <- function(dat,progDir,BUGSDir,i){
  ...
  bayes <- bugs(data=data,                                                         # data to feed to winbugs
                ...
                model.file=paste0(progDir,"/TripleLevelRandomEffectMZone.R"),       # winbugs code
                #debug=TRUE,
  ...
  # output results
  save(data,inits,parameters,bayes,CYear,freqs,file=paste0(outpDir,"/Model O MZone 9.RData"))
