runME10 <- function(dat,progDir,BUGSDir,thisRun,z,j,burn,iter,thin){
  ...
  # output results
  save(data,inits,parameters,bayes,CYear,freqs,time,file=paste0(outpDir,"/Model E MZone ",z," ",thisRun,".RData"))    
