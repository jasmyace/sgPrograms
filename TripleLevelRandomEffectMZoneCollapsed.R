...
#     pi1[u] ~ dnorm(beta10[zoneCls[u]],tauinv2b)        # random effect for lek slope
    pi0[u] ~ dnorm(0,tauinv2a)                           # random effect for lek intercept
    pi1[u] ~ dnorm(0,tauinv2b)                           # random effect for lek slope    
  }
...
#     beta10[v] ~ dnorm(gamma100,tauinv3a)               # random effect for mzone slope
    beta00[v] ~ dnorm(0,tauinv3a)                        # random effect for mzone intercept
    beta10[v] ~ dnorm(0,tauinv3a)                        # random effect for mzone slope
  }
