runMU <- function(dat,progDir,BUGSDir,thisRun,z){
...
#   }
  ...
  bayes <- bugs(data=data,                                                         # data to feed to winbugs
                ...
                model.file=paste0(progDir,"/CorrRandSlopesIntsFixedMZoneBMatMuCent.R"),  # winbugs code
                #debug=TRUE,
  ...
  # output results
  save(data,inits,parameters,bayes,CYear,freqs,time,file=paste0(outpDir,"/Model U MZone ",z," ",thisRun,".RData"))
